...
<html>
    ...
    <body>
        <jsp:useBean id="qualifierBean" type="org.apz.curso.media.MediaQualifier" scope="session" />
        <div class="container">
            <div class="page-header">
                <h1>Media Manager <small class="hidden-xs">- Settings</small></h1>
            </div>
            <form method="post" action="/web-media-manager/MediaController?action=newSettings" class="settings-form">
                <input type="hidden">
                <label>Type: </label>
                <table>
                    <tr>
            ...
            <nav class="navbar navbar-inverse">
                <div class="container">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/web-media-manager">Home</a></li>
                    </ul>
                </div>
            </nav>
        </div>
