<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="model.Usuario, model.Producto"%>
      ...
      <div class="starter-template">
		...
		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
				...
				<table class="table table-hover">
					<thead>
						<tr>
							<th>Producto</th><th>Unidades</th><th>Precio</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="producto" items="${productos}" >
						<tr>
							<td>${producto.nombre}</td><td>${producto.unidades}</td><td>${producto.precio}e</td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
				...
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					...
					<a href="comprar.jsp"  class="btn btn-default">Comprar</a>
			
					<a href="carrito" class="btn btn-danger">Carrito</a>
